...
// Connect before any tests run, disconnect after all are done
beforeAll(async () => {
...
// Clean all collections before each test, so tests never depend on each other's leftover data
beforeEach(async () => {
...
describe('Task API (protected routes)', () => {
  ...
  // Create two separate users and log both in before the task tests run
  beforeEach(async () => {
